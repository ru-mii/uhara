        ...
        internal static AdvancedSignature Get(Enum identifier, string version)
        {
            if (identifier is Function function)
            {
                if (function == Function.StaticConstructObject_Internal)
                {
                    ...
                    else if (version == "5.1.1.0") return new AdvancedSignature("48 89 5C 24 10 48 89 74 24 18 55 57 41 54 41 56 41 57 48 8D AC 24 80 FE FF FF 48");
                    else if (version == "5.3.2.0") return new AdvancedSignature("4C 8B DC 49 89 5B 18 49 89 73 20 55 57 41 54 41 56 41 57 49 8D AB 58 FE FF FF 48");
                ...
                else if (function == Function.UObjectBeginDestroy)
                {
                    ...
                    else if (version == "5.3.2.0") return new AdvancedSignature("40 53 48 83 EC 40 8B 41 08 48 8B D9 C1 E8 0F");
            ...
            else if (identifier is Data data)
            {
                if (data == Data.FNamePool)
                {
                    ...
                    else if (version == "5.3.2.0") return new AdvancedSignature("8B D9 74 ?? 48 8D 15 ???????? EB", true, 4);
